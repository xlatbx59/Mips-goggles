...
impl MgDisassembler{
    ...
    pub fn disassemble(&self, machine_code: u32, address: u64) -> Result<MgInstruction, MgError>{
        ...
        const OPCODE_MAP: [fn (disass: &MgDisassembler, instruction: &mut MgInstructionPrototype) -> Result<(), MgError>; 64] = [
            ...
            MgDisassembler::cpu_loadstore,  MgDisassembler::cpu_loadstore,  MgDisassembler::lwr_swr_lwl_swl,  MgDisassembler::cpu_loadstore,  MgDisassembler::cpu_loadstore,  MgDisassembler::cpu_loadstore,  MgDisassembler::lwr_swr_lwl_swl,  MgDisassembler::lwu,
            MgDisassembler::cpu_loadstore,  MgDisassembler::cpu_loadstore,  MgDisassembler::lwr_swr_lwl_swl,  MgDisassembler::cpu_loadstore,  MgDisassembler::sdl_sdr,  MgDisassembler::sdl_sdr,  MgDisassembler::lwr_swr_lwl_swl,  MgDisassembler::cache_pref,
            MgDisassembler::sc_ll,  MgDisassembler::load_store_cp1,  MgDisassembler::bc_balc,  MgDisassembler::cache_pref,  MgDisassembler::scd_lld, MgDisassembler::load_store_cp1, MgDisassembler::pop66,  MgDisassembler::sd_ld,
            MgDisassembler::sc_ll,  MgDisassembler::load_store_cp1,  MgDisassembler::bc_balc,  MgDisassembler::pcrel_opcode_map,  MgDisassembler::scd_lld,  MgDisassembler::load_store_cp1,  MgDisassembler::pop76,  MgDisassembler::sd_ld];
                ...
                if let Some(op_type) = field.op_type {
                    prototype.operand[field.operand_order] = match op_type{
                        ...
                        MgOperandType::Reg => {
                            ...
                            Some(MgOpRegister::new_reg_operand(MgOpRegister::u8_2_reg(field_mask_result as u8), cop, None))
                        },
                    }
                }
            }
    ...
    fn cpx_cpu_transfer_format(&self, prototype: &mut MgInstructionPrototype, rt: FieldInfos, rd: FieldInfos) -> Result<(), MgError>{
        ...
        prototype.operand[rd.operand_order] = Some(MgOpRegister::new_reg_operand(MgOpRegister::u8_2_reg((prototype.machine_code >> 11 & rd.mask) as u8), rd_cop, None));
        prototype.operand[rt.operand_order] = Some(MgOpRegister::new_reg_operand(MgOpRegister::u8_2_reg((prototype.machine_code >> 16 & rt.mask) as u8), rt_cop, None));
